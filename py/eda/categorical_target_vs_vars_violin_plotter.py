...
class CategoricalTargetVsVarsViolinPlotter:
    """
    ...
    def plot(self, df: pd.DataFrame, tar_col: str = None):
        ...
        for col in obj_cols:
            ...
            sns.violinplot(x=col, y=tar_col, data=_df, ax=ax, inner='box', orient='h', palette='rainbow')
            sns.swarmplot(x=col, y=tar_col, data=_df, ax=ax, size=1, linewidth=1, color='white', orient='h')
